...
export class Web3Service {
  ...
  async accountInfo(account: string) {
    ...
    const initialvalue = await this.getMARSBalance(account);

    this.balance = this.web3js.utils.fromWei(initialvalue, 'ether');
    return this.balance;
  }

  async getMARSBalance(account: string) {
    const tokenInst = new this.web3.eth.Contract(this.BUSD_ABI, this.BUSD_ADDRESS);
    return await tokenInst.methods.balanceOf(account).call()
  }
